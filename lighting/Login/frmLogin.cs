...
namespace HelloWorld
{
	public partial class frmLogin : Form
	{
		...
		{
			if (!string.IsNullOrEmpty(Properties.Settings.Default.Passport))//如果已经存了帐号和密码
			{
		...
		private void btnLogin_Click(object sender, EventArgs e)
		{
            ...
            if (checkBox_notLogin.Checked == false)
            {
                frmHelloWorld.loginState = true;
            ...
            {
                frmHelloWorld.loginState = false;//不启用联网
		...
		private void UILoginComplete(bool success, string msg)
		{
			...
			this.UIInvoke(() => {
				...
				if (success)
				{
                    ...
                    //frmHelloWorld.loginStatus = true;//联网
